...
namespace cfg
{
    ...
    bool test::login::RoleInfo::deserialize(ByteBuf& _buf)
    {
        if (!test::DemoD3::deserialize(_buf))
        {
            return false;
    ...
    bool test::login::RoleInfo::deserializeRoleInfo(ByteBuf& _buf, ::bright::SharedPtr<test::login::RoleInfo>& _out)
    {
    ...
    void test::login::RoleInfo::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
        DemoD3::resolve(_tables);
    }
    ...
    bool test::TestMultiColumn::deserialize(ByteBuf& _buf)
    {
    ...
    bool test::TestMultiColumn::deserializeTestMultiColumn(ByteBuf& _buf, ::bright::SharedPtr<test::TestMultiColumn>& _out)
    {
    ...
    void test::TestMultiColumn::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
        a->resolve(_tables);
        b->resolve(_tables);
        c->resolve(_tables);
    ...
    bool test::Foo::deserialize(ByteBuf& _buf)
    {
    ...
    bool test::Foo::deserializeFoo(ByteBuf& _buf, ::bright::SharedPtr<test::Foo>& _out)
    {
    ...
    void test::Foo::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
    }
    ...
    bool test::ItemBase::deserialize(ByteBuf& _buf)
    {
    ...
    bool test::ItemBase::deserializeItemBase(ByteBuf& _buf, ::bright::SharedPtr<test::ItemBase>& _out)
    {
        int id;
        if (!_buf.readInt(id)) return false;
        switch (id)
    ...
    void test::ItemBase::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
    }

    bool test::Item::deserialize(ByteBuf& _buf)
    {
    ...
    bool test::Item::deserializeItem(ByteBuf& _buf, ::bright::SharedPtr<test::Item>& _out)
    {
    ...
    void test::Item::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
        ItemBase::resolve(_tables);
    }

    bool test::Equipment::deserialize(ByteBuf& _buf)
    {
        if (!test::ItemBase::deserialize(_buf))
        {
            return false;
    ...
    bool test::Equipment::deserializeEquipment(ByteBuf& _buf, ::bright::SharedPtr<test::Equipment>& _out)
    {
    ...
    void test::Equipment::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
        ItemBase::resolve(_tables);
    }

    bool test::Decorator::deserialize(ByteBuf& _buf)
    {
        if (!test::ItemBase::deserialize(_buf))
        {
            return false;
    ...
    bool test::Decorator::deserializeDecorator(ByteBuf& _buf, ::bright::SharedPtr<test::Decorator>& _out)
    {
    ...
    void test::Decorator::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
        ItemBase::resolve(_tables);
    }
    ...
    bool test::Shape::deserialize(ByteBuf& _buf)
    {
    ...
    bool test::Shape::deserializeShape(ByteBuf& _buf, ::bright::SharedPtr<test::Shape>& _out)
    {
        int id;
        if (!_buf.readInt(id)) return false;
        switch (id)
    ...
    void test::Shape::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
    }

    bool test::Circle::deserialize(ByteBuf& _buf)
    {
    ...
    bool test::Circle::deserializeCircle(ByteBuf& _buf, ::bright::SharedPtr<test::Circle>& _out)
    {
    ...
    void test::Circle::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
        Shape::resolve(_tables);
    }

    bool test2::Rectangle::deserialize(ByteBuf& _buf)
    {
        if (!test::Shape::deserialize(_buf))
        {
            return false;
    ...
    bool test2::Rectangle::deserializeRectangle(ByteBuf& _buf, ::bright::SharedPtr<test2::Rectangle>& _out)
    {
    ...
    void test2::Rectangle::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
        Shape::resolve(_tables);
    }
    ...
    bool test::TestScriptableObject::deserialize(ByteBuf& _buf)
    {
    ...
    bool test::TestScriptableObject::deserializeTestScriptableObject(ByteBuf& _buf, ::bright::SharedPtr<test::TestScriptableObject>& _out)
    {
    ...
    void test::TestScriptableObject::resolve(::bright::HashMap<::bright::String, void*>& _tables)
    {
    }
