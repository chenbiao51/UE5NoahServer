...
#ifndef NFI_KCP_MODULE_H
#define NFI_KCP_MODULE_H
...
#include "NFComm/NFNetPlugin/NFIKcp.h"
...
#define KCP_CLIENT_MSG_PROCESS(msgID, msgData, len, msg)                 \
    NFGUID nPlayerID;                                \
    msg xMsg;                                           \
    if (!NFIKcpModule::ReceivePB(msgID, msgData, len, xMsg, nPlayerID))             \
    {                                                   \
...
#define KCP_CLIENT_MSG_PROCESS_NO_OBJECT(msgID, msgData, len, msg)                 \
    NFGUID nPlayerID;                                \
    msg xMsg;                                           \
    if (!NFIKcpModule::ReceivePB(msgID, msgData, len, xMsg, nPlayerID))             \
    {                                                   \
...
#define KCP_CLIENT_MSG_PROCESS_NO_LOG(msgID, msgData, len, msg)                 \
    NFGUID nPlayerID;                                \
    msg xMsg;                                           \
    if (!NFIKcpModule::ReceivePB(msgID, msgData, len, xMsg, nPlayerID))             \
    {                                                   \
...
class NFIKcpModule : public NFIModule
{
public:
