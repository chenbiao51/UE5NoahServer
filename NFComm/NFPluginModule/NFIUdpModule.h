...
#include "NFComm/NFNetPlugin/NFIUdp.h"
...
#define UDP_CLIENT_MSG_PROCESS(msgID, msgData, len, msg)                 \
    NFGUID nPlayerID;                                \
    msg xMsg;                                           \
    if (!NFIUdpModule::ReceivePB(msgID, msgData, len, xMsg, nPlayerID))             \
    {                                                   \
...
#define UDP_CLIENT_MSG_PROCESS_NO_OBJECT(msgID, msgData, len, msg)                 \
    NFGUID nPlayerID;                                \
    msg xMsg;                                           \
    if (!NFIUdpModule::ReceivePB(msgID, msgData, len, xMsg, nPlayerID))             \
    {                                                   \
...
#define UDP_CLIENT_MSG_PROCESS_NO_LOG(msgID, msgData, len, msg)                 \
    NFGUID nPlayerID;                                \
    msg xMsg;                                           \
    if (!NFIUdpModule::ReceivePB(msgID, msgData, len, xMsg, nPlayerID))             \
    {                                                   \
